...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-[#240750] text-white">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div className="lg:w-1/3">
                <div className="flex justify-center space-x-3 lg:justify-start">
                    ...
                    <span className="self-center text-2xl text-[#57A6A1] font-semibold">Asset Guard</span>
                </div>
            </div>
        ...
        <div className="py-6 text-sm text-center text-white">© 2024 Asset Guard All rights reserved.</div>
    </footer>
    );
};
